<?php
    ...
    $years = filter_input(INPUT_POST, 'years',
        FILTER_VALIDATE_INT);
    $compoundInterest = filter_input(INPUT_POST, 'compoundInterest');
...
/*
     else if ( $compoundInterest === FALSE ) {
     $error_message = 'No';}
          else if ( $compoundInterest === TRUE ) {
     $error_message = 'Yes';}
*/
...
<body>
    <main>
        ...
        <span><?php if ($compoundInterest == 'on') {
                    echo 'Yes';
            } else {
                    echo 'No';
            }
